...
async function main() {
  ...
  for (const expected of [
    ...
    "Engine",
    "thumbnailSizes",
    "repeat(auto-fill, minmax(${thumbnailSizes[thumbnailSize].min}px, ${thumbnailSizes[thumbnailSize].max}px))",
    "onDoubleClick",
    "handleGridKeyDown",
    "role=\"grid\"",
  ...
  assertIncludes("Asset Library routing", assetLibraryRouting, "Backgrounds owns the dedicated Upgrade Category background workflow");
