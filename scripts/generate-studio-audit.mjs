...
async function main() {
  ...
  const environmentCandidates = [
    ...
    { itemName: "Environment layer asset API", type: "API", path: "app/api/environment-layer-assets/route.ts", currentPurpose: "Persists multi-layer environment asset records.", evidenceOfUse: "components/environment-layer-generator.tsx fetches this endpoint.", dependents: "Environment layer generators", category: "deprecate", riskLevel: "high", dataMigrationRequired: "Yes; preserve approved paintings as single background asset records first.", recommendation: "Inventory and migrate approved records before removal.", confidence: "high", proposedReplacement: "Canonical flat Environment Painting record per context." },
