...
export default function PlanetArtworkPage() {
  return <PlanetGenerationLibrary rows={PLANET_PROMPT_LIBRARY} canonicalSolRows={CANONICAL_SOL_PROMPTS} focus="planet-artwork" />;
}
