...
export default function HeroDiscoveryShotsPage() {
  return <PlanetGenerationLibrary rows={PLANET_PROMPT_LIBRARY} canonicalSolRows={CANONICAL_SOL_PROMPTS} focus="hero-discovery-shots" />;
}
