...
export default async function ExperienceBibleChapterEditPage({ params }: { params: Promise<{ chapterId: string }> }) {
  ...
  return <ExperienceBibleWorkspace state={state} mode="edit" chapter={chapter} />;
}
