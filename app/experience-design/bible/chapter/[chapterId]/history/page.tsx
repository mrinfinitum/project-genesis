...
export default async function ExperienceBibleChapterHistoryPage({ params }: { params: Promise<{ chapterId: string }> }) {
  ...
  return <ExperienceBibleWorkspace state={state} mode="history" chapter={chapter} />;
}
