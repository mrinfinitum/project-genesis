...
export default function SurfaceLandscapesPage() {
  return <PlanetGenerationLibrary rows={PLANET_PROMPT_LIBRARY} canonicalSolRows={CANONICAL_SOL_PROMPTS} focus="surface-landscapes" />;
}
