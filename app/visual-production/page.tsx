...
export default function VisualProductionPage() {
  return <main className="space-y-6">
    ...
    <section className="grid gap-5 xl:grid-cols-[1.2fr_0.8fr]">
      ...
      <div className="rounded-lg border border-cyan-300/15 bg-slate-950/45 p-6"><h2 className="text-xl font-black text-white">Authoring Surfaces</h2><p className="mt-2 text-sm leading-6 text-slate-400">Open a generator to assemble, copy, validate, and export a Nano Banana 2 prompt pack.</p><div className="mt-5 flex flex-wrap gap-3"><Link href="/creature-generator" className="rounded-md border border-cyan-200/25 bg-cyan-300/10 px-4 py-2.5 text-sm font-black text-cyan-100 hover:bg-cyan-300/20">Creature Generator</Link><Link href="/plant-life-generator" className="rounded-md border border-cyan-200/25 bg-cyan-300/10 px-4 py-2.5 text-sm font-black text-cyan-100 hover:bg-cyan-300/20">Plant Generator</Link><Link href="/visual-production/species-plates" className="rounded-md border border-violet-300/25 bg-violet-300/10 px-4 py-2.5 text-sm font-black text-violet-100 hover:bg-violet-300/20">Species Plates</Link><Link href="/species" className="rounded-md border border-slate-600/60 px-4 py-2.5 text-sm font-black text-slate-200 hover:border-cyan-200/50">Species Library</Link></div></div>
    </section>
  </main>;
}
