...
create table if not exists planet_resource_profiles (
  ...
  primary_resource_ids jsonb default '[]'::jsonb,
  secondary_resource_ids jsonb default '[]'::jsonb,
  rare_resource_ids jsonb default '[]'::jsonb,
  exotic_resource_ids jsonb default '[]'::jsonb,
  resource_weights jsonb default '{}'::jsonb,
  abundance_range jsonb default '{}'::jsonb,
  mining_difficulty_modifier numeric default 0,
  refinement_difficulty_modifier numeric default 0,
