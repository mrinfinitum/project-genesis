    ...
    <main className="mx-auto w-full max-w-[1800px] px-5 py-6 lg:px-8">
      ...
      <div className="grid gap-6 xl:grid-cols-[248px_minmax(0,1fr)]">
        ...
        <section className="min-w-0 rounded-lg border border-cyan-300/20 bg-slate-950/45 p-5 lg:p-7">
          ...
          {section === "components" && (
            <div className="space-y-6"><SectionTitle eyebrow="Component Library" title="Versioned building blocks" detail="The NOVERIS Component Library defines reusable controls. Screen Templates compose those controls into semantic screen contracts without taking layout ownership from Unity." /><div className="grid gap-4 lg:grid-cols-2"><div className="rounded-md border border-cyan-300/20 bg-slate-950/55 p-5"><p className="font-semibold text-slate-100">Canonical components</p><p className="mt-1 max-w-2xl text-sm leading-6 text-slate-400">Components inherit from this Design Language. Unity consumes token references and prefab IDs without copying local screen styling.</p><Link href="/creative-production/design-system/component-library" className="mt-4 inline-flex items-center gap-2 rounded-md border border-cyan-300/35 bg-cyan-300/10 px-3 py-2 text-sm font-semibold text-cyan-50 hover:bg-cyan-300/20"><Component className="h-4 w-4" />Open Component Library</Link></div><div className="rounded-md border border-cyan-300/20 bg-slate-950/55 p-5"><p className="font-semibold text-slate-100">Screen templates</p><p className="mt-1 max-w-2xl text-sm leading-6 text-slate-400">Semantic regions, component dependencies, asset slots, layout modes, validation, and Unity contract export. No positions or anchors are stored here.</p><Link href="/creative-production/design-system/screen-templates" className="mt-4 inline-flex items-center gap-2 rounded-md border border-cyan-300/35 bg-cyan-300/10 px-3 py-2 text-sm font-semibold text-cyan-50 hover:bg-cyan-300/20"><Grid3X3 className="h-4 w-4" />Open Screen Templates</Link></div></div></div>
          )}
