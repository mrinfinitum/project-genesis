...
const commandSeeds: PaletteResult[] = [
  ...
  { id: "command:environment-layers", type: "Environment Composer", title: "Open Environment Asset Library", subtitle: "Reusable authored environment paintings", href: "/environment-composer/layers" },
