...
const commandSeeds: PaletteResult[] = [
  ...
  { id: "command:galaxy-layer-generator", type: "Environment Composer", title: "Open Galaxy Layer Generator", subtitle: "Produce the ten canonical galaxy layers", href: "/galaxy-layer-generator" },
  { id: "command:sector-layer-generator", type: "Environment Composer", title: "Open Sector Layer Generator", subtitle: "Produce the ten canonical sector layers", href: "/sector-layer-generator" },
  { id: "command:star-system-layer-generator", type: "Environment Composer", title: "Open Star System Layer Generator", subtitle: "Produce the thirteen canonical star-system layers", href: "/star-system-layer-generator" },
