# NOVERIS Visual Prompt Library Volume IB Avian Flying Creatures

This canonical Visual Production Engine package contains 1435 production prompt records for Nano Banana 2. It does not generate images or gameplay data.

## Use

1. Select a record by canonical subcategory and production output type.
2. Substitute only the variables defined in `prompt-variables.json` from canonical Studio data.
