# NOVERIS Visual Prompt Library Volume IB Plant Life

This canonical Visual Production Engine package contains 2442 production prompt records for Nano Banana 2. It does not generate images or gameplay data.
...
4. Save the resulting editable PSD/PSB in `source-masters/life/plants`.
