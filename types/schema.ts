...
export type PlanetResourceProfile = {
  ...
  secondary_resource_ids?: string[];
  rare_resource_ids?: string[];
  exotic_resource_ids?: string[];
  resourceWeights?: Record<string, number>;
  resource_weights?: Record<string, number>;
  abundanceRange?: { min: number; max: number };
  abundance_range?: { min: number; max: number };
  miningDifficultyModifier?: number;
  refinementDifficultyModifier?: number;
  mining_difficulty_modifier?: number;
  refinement_difficulty_modifier?: number;
