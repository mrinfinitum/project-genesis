...
export const tableConfigs: Record<TableName, TableConfig> = {
  ...
  assets: {
    table: "assets",
    title: "Assets",
    description: "Game art assets, canonical art keys, platform mappings, source status, and production readiness.",
    statusKey: "status",
    typeKey: "category",
    searchKeys: ["name", "type", "category", "prompt", "art_key", "icon_key", "source_file_name", "source_project", "roblox_asset_id"],
    columns: ["name", "art_key", "icon_key", "category", "dimensions", "source_project", "roblox_asset_id", "usage_count", "status"],
    fields: [
      { key: "id", label: "ID", required: true },
      { key: "name", label: "Name", required: true },
      { key: "type", label: "Type" },
      { key: "category", label: "Category" },
      { key: "art_key", label: "Art Key" },
      { key: "icon_key", label: "Icon Key" },
      { key: "prompt", label: "Prompt", type: "textarea" },
      { key: "source_project", label: "Source Project" },
      ...
      { key: "file_size_bytes", label: "File Size", type: "number" },
      { key: "preview_url", label: "Preview URL" },
      { key: "storage_path", label: "Storage Path" },
      { key: "platform_mappings", label: "Platform Mappings" },
  ...
  planet_resource_profiles: {
    ...
    searchKeys: ["planet_class", "subclass", "discovery_tier", "resource_density", "planet_rarity_bias", "primary_resource_ids", "secondary_resource_ids", "rare_resource_ids", "exotic_resource_ids", "scientific_notes"],
    ...
    fields: [
      ...
      { key: "primary_resource_ids", label: "Primary Resource IDs", type: "array" },
      { key: "secondary_resource_ids", label: "Secondary Resource IDs", type: "array" },
      { key: "rare_resource_ids", label: "Rare Resource IDs", type: "array" },
      { key: "exotic_resource_ids", label: "Exotic Resource IDs", type: "array" },
      { key: "resource_weights", label: "Resource Weights", type: "textarea" },
      { key: "abundance_range", label: "Abundance Range", type: "textarea" },
      { key: "mining_difficulty_modifier", label: "Mining Difficulty Modifier", type: "number" },
      { key: "refinement_difficulty_modifier", label: "Refinement Difficulty Modifier", type: "number" },
      { key: "guaranteed_resources", label: "Legacy Guaranteed Resources", type: "array" },
      { key: "common_resources", label: "Legacy Common Resources", type: "array" },
      { key: "rare_resources", label: "Legacy Rare Resources", type: "array" },
      { key: "exotic_resources", label: "Legacy Exotic Resources", type: "array" },
