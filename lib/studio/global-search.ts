...
const workspaceResults: StudioSearchResult[] = [
  ...
  workspace("environment-layers", "Environment Layer Library", "/environment-composer/layers", "Reusable authored environment layers"),
  workspace("universe-layer-generator", "Universe Layer Generator", "/universe-layer-generator", "Six canonical universe source layers"),
  workspace("galaxy-layer-generator", "Galaxy Layer Generator", "/galaxy-layer-generator", "Ten canonical galaxy source layers"),
  workspace("sector-layer-generator", "Sector Layer Generator", "/sector-layer-generator", "Ten canonical sector source layers"),
  workspace("star-system-layer-generator", "Star System Layer Generator", "/star-system-layer-generator", "Thirteen canonical star-system source layers"),
