...
export const speciesPlatePromptTemplate = "Create a premium NOVERIS scientific museum species plate on a pure black 4000x4000 canvas. Central hero subject, surrounding compatible studies, clear separation, clean isolated and extractable panels, generous negative space, preserved scale and all locked canonical traits. No labels, text, UI, borders, watermark, logo, or frame. PSD-friendly output. Generate {{versionCount}} coherent interpretations; vary only approved secondary traits.";
