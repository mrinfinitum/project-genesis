...
function buildSections(entries: EncyclopediaEntry[]): EncyclopediaSection[] {
  ...
  return [
    ...
    section("planet", "Planets", "Generated planet records and resource profiles.", ["Galaxy", "Galactic Region", "Star System", "Planet"], byType("planet")),
    section("star", "Stars", "Stars and celestial bodies when canonical records exist.", ["Star System", "Star"], byType("star")),
    section("star_system", "Star Systems", "Star system records and their published hierarchy links.", ["Galaxy", "Galactic Region", "Star System"], byType("star_system")),
    section("sector", "Galactic Regions", "Galactic Region records and their canonical Milky Way hierarchy links.", ["Galaxy", "Galactic Region"], byType("sector"), "Compatibility exports retain sector IDs while Studio presents the canonical Galactic Region terminology."),
