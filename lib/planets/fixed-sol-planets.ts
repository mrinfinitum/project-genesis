...
function generatedPlanetFromSolBody(body: CelestialBodyNode, allBodies: CelestialBodyNode[], renderLibrary: PlanetRenderLibraryRecord[] = []): GeneratedPlanet {
  ...
  const planet: GeneratedPlanet = {
    ...
    surface_landscape_status: "Artwork Pending",
    surface_landscape_notes: "Fixed Sol body. Add art from the planet render library when available.",
    image_url: null,
    image_prompt: null,
    image_status: "Artwork Pending",
    image_variants: null,
