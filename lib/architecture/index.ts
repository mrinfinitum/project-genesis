...
export const architectureSections: ArchitectureSection[] = [
  ...
  section("discovery", "Discovery", "Gameplay", "Discovery is a canonical Studio-owned content system for discoverable objects, categories, rarities, spawn rules, collections, chains, milestones, and asset requirements.", ["Studio publishes canonical discovery definitions only.", "Game clients own player collection state, found/not-found state, completion state, and save records.", "Discovery records link to Civilization Encyclopedia entries, Creative Production tasks, Asset Library requirements, runtime payloads, and engine exports.", "Rarity is a collectible/value tier and remains separate from spawn probability.", "Spawn rules are deterministic eligibility rules that clients consume; clients do not invent discovery categories or canonical objects."], ["Discovery", "Encyclopedia", "Asset Library", "Runtime", "Exports"], ["Studio", "Web", "Roblox", "iOS", "Android", "Unity", "Unreal", "Godot"], "Current", ["runtime", "asset-standards"]),
