...
export const architectureDecisions: ArchitectureDecision[] = [
  ...
  { id: "ARCH-DECISION-PERSISTENT-APP-SHELL", title: "Persistent Civilization App Shell", decision: "Top HUD and Left Navigation remain mounted; selections replace Main Workspace only.", reason: "This preserves player orientation, avoids duplicate global HUD geometry, prevents provider remount churn and flashing, keeps economy/global actions persistent, and aligns Web, Roblox, iOS, and Android around the same shell/workspace contract.", date: "2026-07-14", affectedSystems: ["Visual Screen Builder", "Screen Specification", "Component Library", "Game shell", "Roblox shell", "Mobile profiles", "Routing", "Layout exports"], status: "Accepted", supersededBy: null, linkedSectionIds: ["ui-standards", "screen-standards", "component-standards", "mobile"] },
  ...
  { id: "ARCH-DECISION-ASSET-LIBRARY-WORKFLOW", title: "Asset Library Is the Primary Creative Asset Workflow", decision: "Designers upload, organize, approve, and publish assets through Asset Library. Legacy import tools remain internal and are not part of the normal creative workflow.", reason: "This simplifies creative work, avoids implementation terminology, centralizes canonical asset ownership, improves Visual Builder integration, and keeps platform mappings internal.", date: "2026-07-15", affectedSystems: ["Asset Library", "Visual Builder", "Component Library", "Asset Production", "Runtime Assets"], status: "Accepted", supersededBy: null, linkedSectionIds: ["asset-standards", "studio", "ux-standards", "screen-standards", "component-standards"] },
