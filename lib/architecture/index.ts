...
export const architectureSections: ArchitectureSection[] = [
  ...
  section("experience-design", "Experience Design", "Presentation", "Experience Design is the canonical Studio-owned creative authoring environment for NOVERIS direction, references, reviews, and design intent.", ["Experience Design owns the Experience Bible, Inspiration Boards, concept library, screen library, design token collections, materials, motion definitions, component design definitions, themes, brand system, accessibility notes, journey moments, reviews, and version history.", "Experience Design is not gameplay, not rendering, not React implementation, not CSS, and not Three.js.", "The Game owns implementation details including screen layout, camera, shaders, controls, rendering, CSS, React, and platform-specific UI code.", "ED-01 establishes the authoring framework only and must not publish Experience Design content into gameplay runtime until a future explicit contract exists."], ["Experience Design", "Creative Direction", "Design Systems", "Reviews"], ["Studio", "Web", "Roblox", "iOS", "Android"], "Current", ["studio", "ui-standards", "ux-standards", "screen-standards", "component-standards", "asset-standards"]),
  section("environment-composer", "Environment Composer", "Presentation", "Environment Composer is the canonical Studio workspace for reusable layered visual compositions and artistic constraints.", ["Studio owns environment types, layer trees, ordered composition profiles, themes, semantic asset references, visibility rules, seed variation intent, and artistic constraints.", "PSD and other source masters remain private; Studio references approved exported PNG or WebP layers.", "Runtime exports references and presentation intent only. It never embeds textures, private source paths, or client rendering implementation.", "Game clients own cameras, shaders, lighting implementation, controls, platform optimization, and final rendering."], ["Environment Composer", "Layer Library", "Themes", "Runtime Contracts"], ["Studio", "Web", "Roblox", "Unity", "Unreal", "Godot", "iOS", "Android"], "Current", ["experience-design", "asset-standards", "runtime", "studio"]),
...
export const architectureDecisions: ArchitectureDecision[] = [
  { id: "ARCH-DECISION-ENVIRONMENT-COMPOSER", title: "Studio Owns Environment Composition Intent", decision: "Studio owns reusable layered environment profiles, themes, artistic constraints, semantic asset references, and sanitized presentation contracts. Clients own cameras, shaders, lighting implementation, controls, optimization, and final rendering.", reason: "A single authored composition contract preserves art direction across clients without turning Studio into a renderer or exposing private PSD source masters.", date: "2026-07-22", affectedSystems: ["Environment Composer", "Asset Library", "Runtime", "Exports", "Web", "Roblox", "Unity", "Unreal", "Godot"], status: "Accepted", supersededBy: null, linkedSectionIds: ["environment-composer", "asset-standards", "runtime", "studio"] },
  ...
  { id: "ARCH-DECISION-CREATIVE-PRODUCTION-PRIMARY", title: "Creative Production Is the Primary Creative Workflow", decision: "Designers use Creative Production to understand readiness, missing assets, upload needs, and blockers. Canonical system workspaces remain available through their direct Library, World Systems, and Runtime & Verification homes.", reason: "This aligns Studio with creative workflow, improves production visibility, reduces confusion, keeps canonical content tools intact, and separates creative production from systems design.", date: "2026-07-15", affectedSystems: ["Creative Production", "Asset Library", "Navigation", "Production Dashboard", "Canonical Libraries"], status: "Accepted", supersededBy: null, linkedSectionIds: ["asset-standards", "studio", "ux-standards", "production"] },
  ...
  { id: "ARCH-DECISION-EXPERIENCE-DESIGN", title: "Experience Design Is Studio-Owned Creative Direction", decision: "Experience Design is a first-class Studio workspace for the Experience Bible, Inspiration Boards, concepts, screen intent, design tokens, materials, motion, component design definitions, themes, brand, accessibility, journeys, reviews, and version history. It is not gameplay, rendering, React, CSS, or Three.js implementation.", reason: "NOVERIS needs one canonical creative direction source that future clients can consume without making Studio the renderer, layout editor, or client implementation owner.", date: "2026-07-16", affectedSystems: ["Experience Design", "Studio", "Screen Library", "Component Library", "Asset Library", "Brand", "Reviews", "Clients"], status: "Accepted", supersededBy: null, linkedSectionIds: ["experience-design", "studio", "ui-standards", "ux-standards", "screen-standards", "component-standards", "asset-standards"] },
  ...
  { id: "ARCH-DECISION-PLANET-DEVELOPMENT-FRAMEWORK", title: "Planet Development Connects Exploration to Civilization Growth", decision: "Every eligible celestial body follows a canonical knowledge and development lifecycle. Probe and survey Actions progressively reveal information. A completed survey produces a Planet Development Report containing CSI, SVI, opportunity archetype, hazards, restrictions, recommendations, and valid development Actions.", reason: "Planet development needs a Studio-owned decision contract so clients do not invent suitability, value, visibility, valid actions, or project phases, while active player projects remain Game-owned.", date: "2026-07-16", affectedSystems: ["Runtime", "Planet", "Exploration", "Actions", "Discovery", "Colonies", "Mining", "Research", "Terraforming", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "planet", "discovery", "player-systems", "game"] },
  { id: "ARCH-DECISION-CIVILIZATION-PROGRESSION-FRAMEWORK", title: "Civilization Progression Is Deterministic And Non-XP", decision: "Civilization progression is defined by canonical stages, deterministic development dimensions, requirements, milestones, completed Actions, planet development, research, economy, logistics, population, infrastructure, exploration, and civilization identity. It does not use XP or RPG-style levels.", reason: "NOVERIS needs civilization-scale progress that reflects what the player builds and discovers over centuries without turning the game into an RPG level treadmill or storing player progression instances inside Studio runtime.", date: "2026-07-16", affectedSystems: ["Runtime", "Civilization", "Actions", "Planet Development", "Research", "Economy", "Discovery", "Colonies", "Infrastructure", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "civilization-systems", "game", "player-systems", "research", "planet", "discovery"] },
  { id: "ARCH-DECISION-COLONIZATION-MULTI-STAGE-PROJECT", title: "Colonization Is a Multi-Stage Civilization Project", decision: "Colonization and settlement establishment use the Canonical Action System and proceed through explicit planning, allocation, transport, preparation, construction, commissioning, and operational phases. A colony exists only after its required project phases complete. Colonization eligibility is determined by the surveyed Planet Development Profile, technology, resources, logistics, population, preservation policy, Civilization Identity, and civilization progression.", reason: "Colonization must be time-gated, resource-gated, logistics-dependent, population-aware, planet-opportunity-aware, and reversible only through explicit abandonment or decommission policies without storing active player colony instances in Studio.", date: "2026-07-16", affectedSystems: ["Runtime", "Colonization", "Settlements", "Actions", "Planet Development", "Civilization Progression", "Civilization Identity", "Resources", "Buildings", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "civilization-systems", "planet", "player-systems", "game", "asset-standards"] },
  { id: "ARCH-DECISION-RESOURCE-ECONOMY-LOGISTICS-NETWORK", title: "Resources Move Through a Canonical Economy and Logistics Network", decision: "All produced, stored, transported, processed, manufactured, traded, and consumed resources use one canonical Resource Economy & Logistics Framework. Resources exist at locations and move through explicit routes, transport capacity, storage capacity, processing nodes, and time-gated Actions.", reason: "NOVERIS should not allow important resources, equipment, population supplies, fuel, artifacts, samples, or manufactured goods to teleport. Studio publishes the canonical network contracts while the Game owns player inventories, stockpiles, active shipments, route instances, market orders, timestamps, queues, and notifications.", date: "2026-07-16", affectedSystems: ["Runtime", "Economy", "Resources", "Logistics", "Colonization", "Actions", "Buildings", "Markets", "Trade", "Civilization Progression", "Civilization Identity", "AI Agents", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["economy", "runtime", "player-systems", "civilization-systems", "production", "game", "asset-standards"] },
  { id: "ARCH-DECISION-MISSION-EXPEDITION-FRAMEWORK", title: "Missions And Expeditions Are Canonical Contracts", decision: "Mission and expedition types, templates, objectives, rewards, requirements, risks, generation rules, and presentation contracts are Studio-owned canonical content. Accepted missions, active expeditions, objective progress, reward claims, crew assignments, timestamps, and player mission history remain Game-owned.", reason: "Missions connect discovery, planet development, logistics, colonization, research, factions, economy, and encyclopedia content, so clients need one deterministic contract without Studio storing player mission state.", date: "2026-07-16", affectedSystems: ["Runtime", "Missions", "Expeditions", "Actions", "Discovery", "Universal Discovery Registry", "Planet Development", "Colonization", "Resource Economy", "Civilization Progression", "Civilization Identity", "Encyclopedia", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "discovery", "planet", "civilization-systems", "player-systems", "game", "production"] },
  { id: "ARCH-DECISION-DYNAMIC-EVENT-FRAMEWORK", title: "Dynamic Events Emerge from Canonical Conditions and Player History", decision: "Dynamic Events are condition-driven canonical contracts that react to universe state, colony conditions, economy flows, discoveries, missions, Civilization Identity, Civilization Progression, and prior player history. Events may use deterministic probability and seeded variation, but must remain auditable and reproducible where required.", reason: "Events should make the universe feel alive without becoming arbitrary punishment, duplicating the Action/timer engine, leaking hidden knowledge, or storing active player event state in Studio runtime.", date: "2026-07-16", affectedSystems: ["Runtime", "Dynamic Events", "Actions", "Missions", "Expeditions", "Discovery", "Universal Discovery Registry", "Planet Development", "Colonization", "Resource Economy", "Civilization Progression", "Civilization Identity", "AI Agents", "Encyclopedia", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "discovery", "planet", "civilization-systems", "player-systems", "game", "production"] },
  { id: "ARCH-DECISION-POPULATION-STRUCTURED-SIMULATION", title: "Population Is a Structured Civilization Simulation", decision: "Population is modeled through canonical cohorts, workforce roles, needs, growth, migration, education, capacity, and automation substitution. It integrates with colonies, buildings, economy, logistics, Civilization Identity, and Civilization Progression.", reason: "Population should represent living civilization structure rather than a single spendable number, while active player demographics, assignments, migrations, timestamps, and saves remain Game-owned.", date: "2026-07-16", affectedSystems: ["Runtime", "Population", "Colonization", "Buildings", "Economy", "Logistics", "Civilization Progression", "Civilization Identity", "Actions", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "civilization-systems", "player-systems", "game", "economy", "production"] },
  { id: "ARCH-DECISION-RESOURCE-TAXONOMY-V3", title: "ResourceService Owns Canonical Materials", decision: "ResourceService is the single authority for canonical materials, using Resource Taxonomy v3 and stable resource IDs. Discovery-only phenomena, relics, structures, organisms, and knowledge records belong to the Discovery system. Any legacy resource crossing that boundary requires an explicit versioned migration.", reason: "Separating extractable or usable materials from discoveries prevents gameplay systems from treating lore objects as inventory while preserving generated planets, saves, economy references, and client compatibility through deterministic ID migration.", date: "2026-07-20", affectedSystems: ["Resources", "Discovery", "Planet Generation", "Economy", "Crafting", "Research", "Runtime", "Exports", "Game Saves"], status: "Accepted", supersededBy: null, linkedSectionIds: ["economy", "discovery", "runtime", "studio", "game"] },
