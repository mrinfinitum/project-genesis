...
export const architectureDecisions: ArchitectureDecision[] = [
  ...
  { id: "ARCH-DECISION-CANONICAL-ACTION-FRAMEWORK", title: "Canonical Action Framework", decision: "All gameplay activities are represented as versioned, observable, queueable, interruptible, acceleratable, automatable Actions that reference the shared Time Action Contract.", reason: "A single action framework prevents each gameplay feature from inventing its own timer, queue, automation, acceleration, history, and event model.", date: "2026-07-16", affectedSystems: ["Runtime", "Actions", "Exploration", "Research", "Buildings", "Colonies", "Trade", "Travel", "AI Agents", "Premium Crystals", "Game"], status: "Accepted", supersededBy: null, linkedSectionIds: ["runtime", "studio", "game", "research", "planet", "discovery", "player-systems"] },
