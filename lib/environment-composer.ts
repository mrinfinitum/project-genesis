...
const layerTrees: EnvironmentComposerContract["layerTrees"] = {
  ...
  star_system: [
    leaf("system-environment-painting", "01 Environment Painting", 1),
    branch("system-lighting", "02 Lighting", 2, ["Light Rays", "Star Glow", "Lens Glow"]),
    branch("system-stellar", "03 Stellar Objects", 3, ["Stars", "Binary Stars"]),
    branch("system-orbital", "04 Orbital", 4, ["Orbit Styles", "Asteroid Belts"]),
    branch("system-planets", "05 Planets", 5, ["Terrestrial", "Gas Giants", "Ice", "Lava", "Ocean", "Desert"]),
    leaf("system-moons", "06 Moons", 6),
    branch("system-ambient-effects", "07 Ambient Effects", 7, ["Foreground Dust", "Ambient Particles"]),
    branch("system-discovery-effects", "08 Discovery Effects", 8, ["Fog Of War", "Selection", "Discovery", "Ping", "Highlight"]),
    branch("system-ui", "09 UI", 9, ["Labels", "Icons", "Routes"])
  ],
  planet_surface: [
...
const assetSeeds: Array<[string, string, string, EnvironmentAssetVisualFamily, EnvironmentTypeId[], string[], string[]]> = [
  ["far-stars-001", "Far Stars 001", "system-background-far-stars", "stars", ["universe", "galaxy", "sector"], ["midnight-sapphire", "frozen-silence", "deep-void"], ["stars", "distant", "blue", "background"]],
  ["far-stars-002", "Far Stars 002", "system-background-far-stars", "stars", ["universe", "galaxy", "sector"], ["golden-expanse", "crimson-rift"], ["stars", "distant", "warm", "background"]],
  ["mid-stars-001", "Mid Stars 001", "system-background-mid-stars", "stars", ["sector"], ["midnight-sapphire", "emerald-frontier"], ["stars", "mid", "cyan"]],
  ["deep-space-001", "Deep Space 001", "system-background-deep-space", "stars", ["universe", "galaxy", "sector"], ["deep-void", "midnight-sapphire"], ["deep", "space", "black"]],
  ["environment-painting-001", "Environment Painting 001", "system-environment-painting", "stars", ["star_system"], ["midnight-sapphire", "frozen-silence", "deep-void"], ["environment", "painting", "stars", "nebula", "dust", "haze"]],
  ["nebula-blue-004", "Nebula Blue 004", "system-nebulas-rear-nebulas", "nebula", ["galaxy", "sector"], ["midnight-sapphire", "frozen-silence"], ["blue", "nebula", "rear"]],
  ["nebula-violet-002", "Nebula Violet 002", "system-nebulas-front-nebulas", "nebula", ["galaxy", "sector"], ["ancient-violet"], ["violet", "nebula", "front"]],
  ["dust-008", "Dust 008", "system-atmosphere-dust", "dust", ["universe", "galaxy", "sector"], ["midnight-sapphire", "golden-expanse", "deep-void"], ["dust", "transparent", "foreground"]],
  ["haze-003", "Haze 003", "system-atmosphere-haze", "haze", ["galaxy", "sector", "planet_surface"], ["midnight-sapphire", "emerald-frontier", "frozen-silence"], ["haze", "soft", "atmosphere"]],
...
const profileLayerNames: Record<EnvironmentTypeId, string[]> = {
  ...
  star_system: ["Environment Painting", "Light Rays", "Central Star", "Orbit Lines", "Planets", "Moons", "Asteroid Belts", "Ambient Particles", "Foreground Dust", "Fog Of War", "Labels", "Selection Effects"],
