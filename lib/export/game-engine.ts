...
const targetConfigs: Record<EngineTarget, EngineTargetConfig> = {
  roblox: {
    ...
    generatedModules: ["ResourceCatalogModule", "ResearchUnlockModule", "DiscoveryCatalogModule", "UniversalDiscoveryRegistryContract", "SpeciesPlateModule", "DesignLanguageModule", "ComponentLibraryModule", "UniverseDataModule", "ApiService"],
  ...
  unity: {
    ...
    generatedModules: ["ResourceCatalog.cs", "ResearchUnlocks.cs", "NoverisDesignLanguage.json", "NoverisComponentLibrary.json", "UniverseLoader.cs"],
  ...
  unreal: {
    ...
    generatedModules: ["ResourceCatalog", "ResearchUnlockTable", "NoverisDesignLanguage.json", "NoverisComponentLibrary.json", "UniverseData"],
  ...
  godot: {
    ...
    generatedModules: ["ResourceCatalog.gd", "ResearchUnlocks.gd", "NoverisDesignLanguage.json", "NoverisComponentLibrary.json", "UniverseLoader.gd"],
  ...
  web: {
    ...
    generatedModules: ["project-genesis.types.ts", "NoverisDesignLanguage.json", "NoverisComponentLibrary.json", "projectGenesisClient.ts", "projectGenesisStore.ts"],
  ...
  generic: {
    ...
    generatedModules: ["canonical-data.json", "design-language.json", "component-library.json", "schema-notes.json", "relationship-map.json"],
