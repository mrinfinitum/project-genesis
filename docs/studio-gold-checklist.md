# Studio Gold Checklist

- [x] Content Browser has folder tree, grid/list modes, thumbnail size preference, breadcrumbs, URL folders, favorites, recents, and no permanent inspector.
...
- [x] Bulk actions show selected/eligible/skipped status and keep destructive edits review-gated.
- [x] Keyboard shortcuts include arrows, Enter, Space, I, Escape, and Command/Ctrl+A in the Asset Browser.
- [x] Production Health remains Studio-only and sidebar health stays subtle.
- [x] Maintenance-mode policy is documented.
- [x] All six engine exports remain Ready.
